      ...
      <div className="bg-surface px-4 pt-14 pb-4 sticky top-0 z-30 border-b border-line">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-11 h-11 bg-brand-500 rounded-2xl flex items-center justify-center shadow-sm shadow-brand-200 flex-shrink-0">
            <BookMarked size={22} className="text-white" strokeWidth={2.2} />
          </div>
          <div>
            <h1 className="text-2xl font-bold text-ink font-display">Mina prövningar</h1>
            <p className="text-ink-soft text-sm">{savedExams.length} sparade</p>
          </div>
        </div>

        {/* View toggle */}
        <div className="flex bg-sand rounded-2xl p-1 mb-3">
          <button
