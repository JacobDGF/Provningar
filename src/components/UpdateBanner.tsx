...
export function UpdateBanner() {
  return (
    <div className="absolute top-0 left-0 right-0 z-[60] flex justify-center pt-3 px-4 pointer-events-none">
      <div className="pointer-events-auto max-w-sm w-full bg-ink text-white rounded-2xl shadow-lg px-4 py-3 flex items-center gap-3 animate-rise">
        ...
        <button
          ...
          className="bg-white text-ink text-xs font-bold px-3 py-2 rounded-xl flex-shrink-0 active:scale-95 transition-transform"
        >
          Uppdatera
        </button>
      </div>
