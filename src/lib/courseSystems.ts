 ...
 * namn. De är lästa ur de två källor i datan som skriver ut båda systemen på
 * samma rad: Komvux Örebros prövningstabell ("Gamla Gy11: … / Nya Gy25: …") och
 * Helsingborgs jämförelselista över gymnasiala kurser, som ställer gammal kurs
 * och ny ämnesnivå i var sin kolumn. Namnen är datans egen stavning av
 * respektive kod, så en listning och dess motsvarighet aldrig kan säga olika
 * saker om samma kurs.
 *
 * Kurser som bara finns i ett av systemen står inte här, och inte heller de par
 * en källa skriver med en kod som inte finns. Helsingborgs lista sätter samma
 * kod på Psykologi 1 och Psykologi 2, skriver Hälsopedagogik som `HALAHL0` och
 * Specialpedagogik som `SPCSSPE01` — koder ingen listning i datan bär — och
 * parar båda matematikspecialiseringarna med ett och samma `MATMAT00S`. Inget
 * av det går att rätta utan att gissa, och då är tystnad det enda ärliga svaret.
 *
 * Fysik 1a ↔ Fysik Nivå 1b stod länge här som ett exempel på just den
 * tystnaden: Örebro listar dem var för sig utan att para ihop dem. Helsingborgs
 * lista skriver dem på samma rad, och paret är därför läst, inte gissat.
 *
 * Källor: gymnasieskolor.orebro.se, Komvux Örebros prövningstabell hösten 2026,
 * läst 2026-09-10; helsingborg.se, jämförelselistan Gy11/Gy25 som stadens
 * betygsprövningssida länkar till, läst 2026-09-18.
 */
