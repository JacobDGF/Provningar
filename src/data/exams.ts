...
// Göteborgssvepet: hela Prövningsenhetens kurskatalog, läst kurs för kurs ur
// anordnarens egen kurslista, med provdatum och sista anmälningsdag från varje
// kurssida. Läst om 2026-09-25, alla 215 kurser mot samma katalog: 185 stämde
// på dagen, och de 30 vars enda prövningstillfälle hunnit passera står nu som
// obekräftade — Alvis startsida säger att vårens prövningar publiceras 1
// december och att första ansökningsdag är 15 december, så det finns inget
// nästa datum att flytta fram till än.
const GOTEBORG_VERIFIED = '2026-09-25';
...
// Dagssvepet 2026-09-25: de listningar check:dates pekade ut som förbi, lästa
// en och en mot anordnarens egen sida och flyttade fram till den omgång
// anordnaren själv publicerat — eller satta som obekräftade där ingen finns.
const SEP_25_VERIFIED = '2026-09-25';
...
export const EXAMS: Exam[] = [
  ...
  },
  {
    ...
    // Checked 2026-08-20: Iris skrev i versaler att alla platser till
    // septembertillfället var bokade, och listningen bar `full` tills det
    // tillfället skrivits. Läst om 2026-09-25: september är passerat och Iris
    // har satt ut nästa datum — 8 december, med anmälan 5 november kl. 9 — så
    // omgången är öppen igen och `full` är borta.
    nextPeriod: {
      label:
        'Provtillfälle tisdag 8 december 2026 kl. 9:00 — sluttiden beror på provet. Anmälan öppnar ' +
        'torsdag 5 november kl. 9:00 och stänger så snart de 25 platserna är fullbokade. ' +
        'Formuläret visas bara den dagen, och platserna brukar gå åt på minuter. ' +
        '(Septembertillfället är skrivet.)',
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Provtillfälle fredag 11 december 2026 kl. 8:00–17:00. Anmälan öppnar torsdag 12 november ' +
        'kl. 9:00 och stänger samma förmiddag — formuläret visas bara den dagen och avaktiveras ' +
        'när de 60 platserna är fullbokade. (Septembertillfället är skrivet och var fullbokat.)',
  ...
  },
  {
    ...
    nextPeriod: {
      ...
      // får man med antagningsbeskedet. Läst om 2026-09-25: tabellen
      // "Anmälningstider för hösten 2026" står kvar men båda raderna är förbi —
      // oktoberomgången står som STÄNGD — och vårens tider är inte publicerade.
      label:
        'Höstens båda anmälningsomgångar är stängda (september och oktober). Vårens ' +
        'anmälningstider är inte publicerade än — de kommer i tabellen på skolans egen sida.',
      confirmed: false,
    },
    components: COMPONENTS_MATEMATIK,
    studyTips: TIPS_MATEMATIK,
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Ansökan till vårens studieperiod ska vara inlämnad senast 1 februari 2027 — ' +
        'Kunskapsförbundet skriver att höstens ansökan är stängd',
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Ansökan öppen 10 december 2026–28 februari 2027, med prövning i april–juni. ' +
        '(Höstens period stängde 10 september och den prövningen genomförs i november.)',
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        ...
        '(höstens period stängde 1 september 2026)',
  ...
  },
  {
    ...
    // Läst 2026-09-25: tillfälle 1 den 7 september är skrivet och står som
    // FULLT på ABF:s sida. Tillfälle 2 är 9 november (ev. del 2 den 13 nov),
    // med anmälan 26 oktober kl. 10 och sista betaldag 30 oktober.
    nextPeriod: {
      label:
        'Tillfälle 2 hösten 2026: prövning 9 november (ev. del 2 den 13 november). Anmälan öppnar ' +
        '26 oktober kl. 10 och sista betaldag är 30 oktober. Tillfälle 1 den 7 september är skrivet.',
    ...
    studyTips: TIPS_VARD,
    // Checked 2026-08-13, läst om 2026-09-25: "Anmälan sker ENDAST via ett
    // formulär på denna webbsida, formuläret syns först när anmälan öppnar."
    // Formuläret till tillfälle 2 läggs upp 26 oktober kl. 10, betalning senast
  ...
  },
  {
    ...
    nextPeriod: {
      // Läst om 2026-09-25: engelska nivå 1–3 låg tidigare under ett gemensamt
      // datumblock, men ABF delar numera upp dem. Nivå 1 och 2 har ett enda
      // tillfälle i höst — 1 oktober, ev. del 2 den 12 oktober — och ABF har
      // skrivit "(FULLT!)" vid det. Det är nivå 3 som har tillfälle 2 den
      // 9 november, och den kursen är inte den här listningen.
      label:
        'Prövning 1 oktober 2026 (del 2 den 12 oktober). Anmälan öppnade 24 augusti kl. 10 med ' +
        'sista betaldag 28 augusti, och ABF skriver att tillfället är fullt. Något ytterligare ' +
        'tillfälle i engelska nivå 1–2 är inte utsatt för hösten.',
    ...
    // Checked 2026-08-13, läst om 2026-09-25: "Anmälan sker ENDAST via ett
    // formulär på denna webbsida, formuläret syns först när anmälan öppnar."
    // Höstens formulär låg uppe 24 augusti kl. 10 och tillfället är fullt; ABF
    // har inte satt ut någon ny öppningsdag för engelska nivå 1–2.
    registration: publishedOnPage(
      'anmälningsformuläret',
      'den dag ABF sätter ut för nästa tillfälle',
    ),
    registrationUrl: 'https://abfstockholm.se/komvux/provning/',
    infoUrl: 'https://abfstockholm.se/komvux/provning/',
    description:
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Nästa prövningstillfälle är 15 mars 2027, anmälan öppen 25 januari–21 februari. ' +
        'Begränsat antal platser och först till kvarn, så anmälan kan stänga tidigare; ' +
        'sista dag att betala är 21 februari.',
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Vårens anmälningsperiod är 2 januari–15 februari 2027. Prövningen tar oftast cirka sex ' +
        'veckor och skolan har inga fasta prövningsdatum. (Höstens period stängde 15 september.)',
  ...
  },
  {
    ...
    // Läst 2026-09-25: period 2 2026 stängde 22 augusti. Kommunen skriver ut
    // båda periodernas datum utan årtal — period 1 öppnar 15 februari, sista
    // anmälningsdag 22 februari, sista betaldag 7 mars och prövningen ska vara
    // genomförd senast 30 juni — så nästa period är den i februari 2027.
    nextPeriod: {
      label:
        'Period 1 2027: anmälan öppnar 15 februari, sista anmälningsdag 22 februari, sista betaldag ' +
        '7 mars, prövningen ska vara genomförd senast 30 juni',
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Vårens ansökningsperiod 2027: 1 januari – 26 januari. Prövningen startar två veckor efter ' +
        'att ansökan stänger och pågår i cirka fem veckor.',
  ...
  // ----------------------------------------------------------------------
  {
    ...
    nextPeriod: {
      label:
        'Ansökan till vårens studieperiod ska vara inne senast 1 februari 2027. ' +
        'Höstens ansökan är stängd enligt Kunskapsförbundet.',
      applicationEnd: '2027-02-01',
      confirmed: true,
    },
    components: COMPONENTS_FLERA,
  ...
  },
  {
    ...
    nextPeriod: {
      ...
      label:
        ...
        'Prövningsdatum får du besked om när ansökan har bedömts. (Höstens period stängde 28 augusti 2026.)',
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Hösten 2026 har två prövningstillfällen och det första har passerat — anmäl dig senast ' +
        '20 oktober. (Våren: senast 20 februari eller 1 april.)',
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Höstens prövningstillfälle är genomfört — provet skrevs fredag 11 september 2026. Vårens prövningar ' +
        'publiceras 1 december och första ansökningsdag är 15 december.',
      confirmed: false,
    },
    components: COMPONENTS_FLERA,
    studyTips: TIPS_PROGRAMMERING,
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Programmering 1 (PRRPRR01) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs fredag 11 september 2026 på Lindholmens tekniska gymnasium; vårens prövningar publiceras 1 december.',
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Programmering Nivå 1 (PROG1000X) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs fredag 11 september 2026 på Lindholmens tekniska gymnasium; vårens prövningar publiceras 1 december.',
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Höstens prövningstillfälle är genomfört — provet skrevs tisdag 22 september 2026. Vårens prövningar ' +
        'publiceras 1 december och första ansökningsdag är 15 december.',
      confirmed: false,
    },
    components: COMPONENTS_ENGELSKA,
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Engelska 7 (ENGENG07) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs tisdag 22 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
    tags: ['engelska', 'göteborg', 'västra götaland', 'gy11'],
    verifiedAt: GOTEBORG_VERIFIED,
  },
  {
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Engelska Nivå 3 (ENGE3000X) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs tisdag 22 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
    tags: ['engelska', 'göteborg', 'västra götaland', 'gy25'],
    verifiedAt: GOTEBORG_VERIFIED,
  },
  {
    ...
    nextPeriod: {
      label:
        'Höstens prövningstillfälle är genomfört — provet skrevs torsdag 24 september 2026. Vårens prövningar ' +
        'publiceras 1 december och första ansökningsdag är 15 december.',
      confirmed: false,
    },
    components: COMPONENTS_FLERA,
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Filosofi 1 (FIOFIO01) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs torsdag 24 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Filosofi 2 (FIOFIO02) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs torsdag 24 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
    tags: ['filosofi', 'göteborg', 'västra götaland', 'gy11'],
    verifiedAt: GOTEBORG_VERIFIED,
  },
  {
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Historia 1a1 (HISHIS01a1) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs torsdag 24 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Historia 1a2 (HISHIS01a2) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs torsdag 24 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
    tags: ['historia', 'göteborg', 'västra götaland', 'gy11'],
    verifiedAt: GOTEBORG_VERIFIED,
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Historia 1b (HISHIS01b) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs torsdag 24 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
    tags: ['historia', 'göteborg', 'västra götaland', 'gy11'],
    verifiedAt: GOTEBORG_VERIFIED,
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Historia 2a (HISHIS02a) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs torsdag 24 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
    tags: ['historia', 'göteborg', 'västra götaland', 'gy11'],
    verifiedAt: GOTEBORG_VERIFIED,
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Historia 3 (HISHIS03) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs torsdag 24 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
    tags: ['historia', 'göteborg', 'västra götaland', 'gy11'],
    verifiedAt: GOTEBORG_VERIFIED,
  },
  {
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Modersmål Nivå 2, Arabiska (MODE2000XARA) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs tisdag 22 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Modersmål Nivå 2, Persiska (MODE2000XPES) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs tisdag 22 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Modersmål Nivå 2, Polska (MODE2000XPOL) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs tisdag 22 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Modersmål Nivå 2, Somaliska (MODE2000XSOM) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs tisdag 22 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Naturkunskap 1a1 (NAKNAK01a1) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs torsdag 24 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Naturkunskap 1a2 (NAKNAK01a2) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs torsdag 24 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
    tags: ['naturkunskap', 'göteborg', 'västra götaland', 'gy11'],
    verifiedAt: GOTEBORG_VERIFIED,
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Naturkunskap 1b (NAKNAK01b) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs torsdag 24 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
    tags: ['naturkunskap', 'göteborg', 'västra götaland', 'gy11'],
    verifiedAt: GOTEBORG_VERIFIED,
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Naturkunskap 2 (NAKNAK02) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs tisdag 22 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
    tags: ['naturkunskap', 'göteborg', 'västra götaland', 'gy11'],
    verifiedAt: GOTEBORG_VERIFIED,
  },
  {
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Psykologi 1 (PSKPSY01) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs torsdag 24 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Psykologi 2a (PSKPSY02a) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs torsdag 24 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
    tags: ['psykologi', 'göteborg', 'västra götaland', 'gy11'],
    verifiedAt: GOTEBORG_VERIFIED,
  },
  {
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Religionskunskap 1 (RELREL01) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs torsdag 24 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Religionskunskap 2 (RELREL02) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs torsdag 24 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
    tags: ['religionskunskap', 'göteborg', 'västra götaland', 'gy11'],
    verifiedAt: GOTEBORG_VERIFIED,
  },
  {
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Samhällskunskap 1a1 (SAMSAM01a1) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs torsdag 24 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Samhällskunskap 1a2 (SAMSAM01a2) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs torsdag 24 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
    tags: ['samhällskunskap', 'göteborg', 'västra götaland', 'gy11'],
    verifiedAt: GOTEBORG_VERIFIED,
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Samhällskunskap 1b (SAMSAM01b) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs torsdag 24 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
    tags: ['samhällskunskap', 'göteborg', 'västra götaland', 'gy11'],
    verifiedAt: GOTEBORG_VERIFIED,
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Samhällskunskap 2 (SAMSAM02) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs torsdag 24 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
    tags: ['samhällskunskap', 'göteborg', 'västra götaland', 'gy11'],
    verifiedAt: GOTEBORG_VERIFIED,
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Samhällskunskap 3 (SAMSAM03) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs torsdag 24 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
    tags: ['samhällskunskap', 'göteborg', 'västra götaland', 'gy11'],
    verifiedAt: GOTEBORG_VERIFIED,
  },
  {
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Etnicitet och kulturmöten (SOIETN0) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs torsdag 24 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Sociologi (SOISOO0) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs torsdag 24 september 2026 på Burgårdens gymnasium; vårens prövningar publiceras 1 december.',
    tags: ['sociologi', 'göteborg', 'västra götaland', 'gy11'],
    verifiedAt: GOTEBORG_VERIFIED,
  },
  {
