...
// Svepet 2026-09-22: de tjugo listningar vars publicerade omgång hade hunnit
// passera helt läsades om hos anordnaren, en sida i taget. De flesta rullade
// vidare till nästa period anordnaren själv skriver ut; Umevux och
// Prövningsenheten Göteborg hade ingen ny att rulla till, och står nu odaterade
// i stället för att visa en omgång som varit.
const SEP_22_VERIFIED = '2026-09-22';
...
export const EXAMS: Exam[] = [
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Nästa provtillfälle är tisdag 8 december 2026 kl. 9–12. Anmälan öppnar torsdag ' +
        '5 november kl. 09:00 och stänger så snart platserna är fullbokade. Formuläret visas ' +
        'bara den dagen, och platserna brukar gå åt på minuter. ' +
        '(Därefter: 16 februari 2027, med anmälan från 11 december 2026.)',
  ...
  },
  {
    ...
    nextPeriod: {
      // Kontrollerat 2026-09-22: Iris skriver "ALLA PRÖVNINGSPLATSER FÖR DEN
      // 25:e SEPTEMBER I FLEMINGSBERG ÄR BOKADE!" — omgången är alltså stängd
      // med anordnarens egna ord, inte bara med kalenderns. Nästa datum står
      // utskrivet på samma sida.
      label:
        'Provtillfället 25 september 2026 är fullbokat — Iris skriver att alla platser är ' +
        'bokade. Nästa tillfälle är fredag 11 december kl. 8–17, med anmälan som öppnar ' +
        'torsdag 12 november kl. 09:00 och stänger när platserna är fullbokade. Formuläret ' +
        'visas bara den dagen, och platserna brukar gå åt fort.',
      applicationStart: '2026-08-27',
      applicationEnd: '2026-08-27',
      examWindowStart: '2026-09-25',
      examWindowEnd: '2026-09-25',
  ...
  },
  {
    ...
    nextPeriod: {
      // Umevux skriver 2026-09-22 rakt ut "ANMÄLAN TILL PRÖVNINGAR STÄNGD — just
      // nu har vi ingen aktuell prövningsperiod att anmäla sig till", och att
      // vårens tillfällen läggs ut när de är fastställda. Då står listningen
      // odaterad hellre än att visa höstens fönster som varit.
      label:
        'Anmälan är stängd. Umevux har ingen aktuell prövningsperiod, och skriver att ' +
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Ansökan till vårens studieperiod 2027 ska vara inlämnad senast 1 februari 2027 ' +
        '(höstens period senast 1 september)',
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Ansökan öppen 10 december–28 februari (prövning genomförs i april–juni) samt ' +
        '10 juni–10 september (prövning i november)',
  ...
  },
  {
    ...
    nextPeriod: {
      // Kontrollerat 2026-09-22: septembertillfället är genomfört och står som
      // FULLT hos ABF. Kvar av hösten är tillfälle 2 den 9 november, med samma
      // anmälningsfönster för undersköterskeämnena, moderna språk,
      // naturkunskap, SO och engelska nivå 3.
      label:
        ...
        'Platserna är begränsade och först till kvarn gäller.',
  ...
  },
  {
    ...
    nextPeriod: {
      // Kontrollerat 2026-09-22: ABF listar numera Engelska nivå 1 (ENGE1000X)
      // och nivå 2 (ENGE2000X) under ett enda tillfälle den 1 oktober, inte
      // under samma datumblock som nivå 3. Anmälan stängde 28 augusti och ABF
      // har skrivit ut "(FULLT!)", så omgången är stängd fast provet är kvar.
      label:
        'Höstens enda tillfälle för engelska nivå 1 och 2 är 1 oktober 2026 (del 2 den ' +
        '12 oktober). Anmälan öppnade 24 augusti kl. 10 och sista betaldag var 28 augusti — ' +
        'ABF har markerat tillfället som fullt. Nivå 3 har ett tillfälle till den 9 november.',
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        ...
        'Sista dag att betala är 21 februari, och anmälan kan stänga tidigare om platserna tar slut.',
  ...
  },
  {
    ...
    nextPeriod: {
      // Motala har inga fasta prövningsdatum — omgången är anmälningsfönstret,
      // och prövningen tar oftast sex veckor efter att anmälan bedömts.
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        ...
        'sista betalningsdag 7 mars, prövning ska vara genomförd senast 30 juni',
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        ...
        'grundläggande och gymnasial nivå. (Höstens period: 1 augusti – 1 september.)',
  ...
  // ----------------------------------------------------------------------
  {
    ...
    nextPeriod: {
      label:
        ...
        'Höstens period stänger 1 september.',
      applicationEnd: '2027-02-01',
      confirmed: true,
    },
    components: COMPONENTS_FLERA,
  ...
  },
  {
    ...
    nextPeriod: {
      // Som i höstas skriver Värnamo ut månaden ansökan öppnar men inte dagen,
      // så bara sista dagen står här — ett påhittat startdatum vore ett sämre
      // svar än inget.
      label:
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Höstens andra prövningstillfälle 2026: anmäl dig senast 20 oktober. ' +
  ...
  },
  {
    ...
    priceNote: GBG_PRICE_NOTE,
    nextPeriod: {
      // Kontrollerat 2026-09-22 i Alvis: 11 september är det obligatoriska
      // informationsmötet, inte slutet på omgången. Det skriftliga provet
      // skrivs torsdag 15 oktober kl. 17.30–21.30 på Burgårdens konferens, så
      // omgången pågår fortfarande — examWindowEnd låg tidigare på mötesdagen
      // och fick listningen att se utgången ut en månad för tidigt.
      label:
        'Anmälan stängde 14 augusti. Obligatoriskt informationsmöte fredag 11 september 2026 ' +
        'kl. 15.00–17.00 på Lindholmens tekniska gymnasium, och skriftligt prov torsdag ' +
        '15 oktober kl. 17.30–21.30 på Burgårdens konferens. Vårens prövningar publiceras ' +
        '1 december och första ansökningsdag är 15 december.',
      applicationEnd: '2026-08-14',
