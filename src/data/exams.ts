 ...
 */
/**
 * Prövningsperiod 4 tar bara matematik. Linvux kör fyra perioder per år men
 * varje period har sin egen kurslista, och period 4 är den enda som inte
 * erbjuder hela utbudet — därför två helpers i stället för en delad.
 */
function linvuxPeriod4(): NextPeriod {
  return {
    label:
      'Prövningsperiod 4 2026 (endast matematik): ansökan öppnade 21 september klockan 8 och ' +
      'stänger 16 oktober. Proven skrivs vecka 51, det vill säga 14–20 december; vissa ' +
      'prövningar kan påbörjas tidigare eller senare. Du kan bli antagen till högst tre kurser ' +
      'per period.',
...
// Dagens datumsvep: de 27 listningar vars publicerade omgång var helt förbi
// lästes om mot anordnarens egen sida. De som publicerat nästa omgång har
// flyttats fram; de som inte gjort det står som odaterade i stället för att
// visa ett datum som varit.
const SEP_24_VERIFIED = '2026-09-24';
...
export const EXAMS: Exam[] = [
  ...
  },
  {
    ...
    // Septembertillfället såldes slut ("Slut i lager") och stod som `full` tills
    // det passerade. Datumen här är decembertillfället, som Iris skrev ut redan
    // vid kontrollen 2026-08-20 — deras sida svarar bara med Cloudflares
    // verifieringssida för en automatiserad läsare, så `verifiedAt` står kvar på
    // den dagen och nästa kontroll får göras i en webbläsare.
    nextPeriod: {
      label:
        'Provtillfället 8 september 2026 är genomfört. Nästa tillfälle är tisdag 8 december kl. 9–12, med anmälan som öppnar torsdag 5 november kl. 9:00 och stänger så snart platserna är fullbokade. Formuläret visas bara den dagen, och platserna brukar gå åt på minuter.',
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Anmälan till prövningar är stängd: "Just nu har vi ingen aktuell prövningsperiod att anmäla sig till." Anmälan till prövningstillfällen för våren 2027 läggs ut när de är fastställda.',
      confirmed: false,
    },
    components: COMPONENTS_MATEMATIK,
    studyTips: TIPS_MATEMATIK,
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        '"Ansökan om prövning till hösten 2026 är stängd." Vårens studieperiod har sista ansökningsdag 1 februari; när ansökan öppnar skriver skolan inte ut.',
      confirmed: false,
    },
    components: COMPONENTS_FLERA,
    studyTips: TIPS_FLERA,
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Höstens ansökan (10 juni–10 september) är stängd och den omgångens prövningar genomförs i november. Nästa ansökan är öppen 10 december–28 februari, med prövning i april–juni.',
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Tillfälle 1 den 7 september är genomfört och var fullt. Tillfälle 2 hösten 2026: anmälan öppnar 26 oktober kl. 10 och sista betaldag är 30 oktober, prövning 9 november (ev. del 2 den 13 november).',
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Tillfälle 1 den 7 september är genomfört och var fullt. Tillfälle 2 hösten 2026: anmälan öppnar 26 oktober kl. 10 och sista betaldag är 30 oktober, prövning 9 november (del 2 den 13 november). Engelska prövas i två delar och båda måste göras.',
      applicationStart: '2026-10-26',
      applicationEnd: '2026-10-30',
      examWindowStart: '2026-11-09',
      examWindowEnd: '2026-11-13',
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Höstens omgång är genomförd. Våren 2027: anmälan 25 januari–21 februari, sista betaldag 21 februari, prövning 15 mars 2027. Begränsat antal platser och först till kvarn, så anmälan kan stänga tidigare.',
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Höstens anmälningsperiod tog emot anmälningar till och med 15 september 2026. Vårens anmälningsperiod är 2 januari–15 februari 2027.',
    ...
    description:
      'Motala vuxenutbildning tar emot anmälningar i två perioder per år; vårens period är 2 januari–15 februari 2027. Anmälan görs på blankett, som bara ligger uppe när en anmälningsperiod är öppen. Prövningen tar oftast cirka sex veckor och saknar fasta provdatum.',
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Period 2 2026 är stängd. Period 1 2027: anmälan öppnar 15 februari, sista anmälningsdag 22 februari, prövning ska vara genomförd senast 30 juni.',
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Höstens ansökningsperiod 2026 är stängd. Nästa period är 1–26 januari 2027; prövningen startar två veckor efter att ansökan stänger och pågår i cirka fem veckor.',
  ...
  },
  {
    ...
    nextPeriod: {
      // Vårens sista ansökningsdag står utskriven, men inte när ansökan
      // öppnar — sidan säger bara "öppen i januari". Ett påhittat startdatum
      // vore ett sämre svar än inget, så perioden står som odaterad och
      // etiketten bär datumet i klartext.
      label:
        'Höstens ansökan stängde 28 augusti 2026. Våren 2027 är sista ansökningsdag 29 januari, och ansökan öppnar under januari — något startdatum skriver skolan inte ut.',
      confirmed: false,
    },
    components: COMPONENTS_FLERA,
    studyTips: TIPS_FLERA,
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Hösten 2026 har två prövningstillfällen. Det första stängde 20 september; nästa sista anmälningsdag är 20 oktober. (Våren: senast 20 februari eller 1 april.)',
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Höstens omgång är genomförd — provet skrevs fredag 11 september 2026. Vårens prövningar publiceras 1 december och första ansökningsdag är 15 december.',
      confirmed: false,
    },
    components: COMPONENTS_FLERA,
    studyTips: TIPS_PROGRAMMERING,
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Programmering 1 (PRRPRR01) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs fredag 11 september 2026 kl. 15.00–17.00 på Lindholmens tekniska gymnasium. Vårens prövningsdatum publiceras 1 december.',
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Programmering Nivå 1 (PROG1000X) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs fredag 11 september 2026 kl. 15.00–17.00 på Lindholmens tekniska gymnasium. Vårens prövningsdatum publiceras 1 december.',
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Höstens omgång är genomförd — provet skrevs tisdag 22 september 2026. Vårens prövningar publiceras 1 december och första ansökningsdag är 15 december.',
      confirmed: false,
    },
    components: COMPONENTS_ENGELSKA,
    studyTips: TIPS_ENGELSKA,
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Engelska 7 (ENGENG07) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs tisdag 22 september 2026 kl. 17.30–22.30 på Burgårdens gymnasium. Vårens prövningsdatum publiceras 1 december.',
    tags: ['engelska', 'göteborg', 'västra götaland', 'gy11'],
    verifiedAt: SEP_24_VERIFIED,
  },
  {
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Engelska Nivå 3 (ENGE3000X) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs tisdag 22 september 2026 kl. 17.30–22.30 på Burgårdens gymnasium. Vårens prövningsdatum publiceras 1 december.',
    tags: ['engelska', 'göteborg', 'västra götaland', 'gy25'],
    verifiedAt: SEP_24_VERIFIED,
  },
  {
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Modersmål Nivå 2, Arabiska (MODE2000XARA) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs tisdag 22 september 2026 kl. 17.30–21.30 på Burgårdens gymnasium. Vårens prövningsdatum publiceras 1 december.',
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Modersmål Nivå 2, Persiska (MODE2000XPES) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs tisdag 22 september 2026 kl. 17.30–21.30 på Burgårdens gymnasium. Vårens prövningsdatum publiceras 1 december.',
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Modersmål Nivå 2, Polska (MODE2000XPOL) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs tisdag 22 september 2026 kl. 17.30–21.30 på Burgårdens gymnasium. Vårens prövningsdatum publiceras 1 december.',
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Modersmål Nivå 2, Somaliska (MODE2000XSOM) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs tisdag 22 september 2026 kl. 17.30–21.30 på Burgårdens gymnasium. Vårens prövningsdatum publiceras 1 december.',
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Betygsprövning i Naturkunskap 2 (NAKNAK02) hos Göteborgs Stads prövningsenhet, som samordnar prövningar för hela kommunen. Höstens prov skrevs tisdag 22 september 2026 kl. 17.30–21.30 på Burgårdens gymnasium. Vårens prövningsdatum publiceras 1 december.',
    tags: ['naturkunskap', 'göteborg', 'västra götaland', 'gy11'],
    verifiedAt: SEP_24_VERIFIED,
  },
  {
