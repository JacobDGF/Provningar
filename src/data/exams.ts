...
// Helsingborgssvepet 2026-09-18: hela stadens prövningsutbud, läst ur
// kommunens egen kurslista (PDF:en betygsprövningssidan länkar till) och ur
// periodtabellen på samma sida.
const SEP_18_VERIFIED = '2026-09-18';

const HBG_PRICE_NOTE =
  '500 kr per kurs eller ämnesnivå och prövningstillfälle, och avgiften ska vara betald senast ' +
  'sista anmälningsdag — betalningen görs på plusgiro, och kvittot mejlas till kommunen. ' +
  'Kostnadsfritt om du tidigare fått betyget F i kursen. Inbetald avgift betalas inte tillbaka.';
...
/**
 * Helsingborgs fyra gymnasiala prövningsperioder 2026 slutar med den här, och
 * kommunen har inte publicerat några datum för 2027 — därför bär varje
 * listning periodens riktiga datum i stället för en gissad fortsättning.
 *
 * Fönstret är fem dagar långt, vilket är hela skälet till att datumen står
 * utskrivna: den som missar den veckan får vänta på nästa omgång, och
 * anmälningsdagen är den enda dag beslutet går att fatta.
 */
const HBG_PERIOD_4: NextPeriod = {
  label:
    'Prövningsperiod 4 2026: anmälan var öppen 7–11 september och avgiften skulle vara betald ' +
    'senast 11 september. Prövningen görs 12 oktober–6 november, med ett fast provdatum inom ' +
    'perioden som inte går att ändra. Du kan göra högst två prövningar per prövningsperiod. ' +
    'Kommunen har inte publicerat några prövningsperioder för 2027.',
  applicationStart: '2026-09-07',
...
/** Grundläggande nivå har två perioder om året i stället för fyra, med samma
    datum som gymnasiala period 4 i höst. */
const HBG_GRUND_PERIOD_2: NextPeriod = {
  label:
    'Prövningsperiod 2 2026 på grundläggande nivå: anmälan var öppen 7–11 september, sista ' +
    'betalningsdag 11 september, och prövningen görs 12 oktober–6 november. Grundläggande ' +
    'kurser har två perioder om året — vårens ansökan var öppen 2–6 mars.',
  applicationStart: '2026-09-07',
  applicationEnd: '2026-09-11',
  examWindowStart: '2026-10-12',
  examWindowEnd: '2026-11-06',
...
/**
 * Helsingborg beskriver upplägget en gång för hela utbudet i stället för per
 * kurs: delarna varierar med ämnet, men vilka delar som kan förekomma, vad som
 * har fast tid och vad du bokar själv gäller varenda prövning.
 */
const COMPONENTS_HELSINGBORG: ExamComponent[] = [
  {
    name: 'Skriftligt prov',
    duration: 'Fast tid inom perioden',
    description:
      'Du tilldelas ett provdatum inom prövningsperioden som inte går att ändra, och vissa prov görs på plats. Ta med legitimation.',
  },
  {
    name: 'Muntligt prov',
    duration: 'Bokas med läraren',
    description:
      'Tiden bokar du själv med läraren i lärplattformen Exlearn, som du får inloggning till efter anmälan.',
  },
  {
    name: 'Laboration, praktiskt moment eller inlämningsuppgift',
    duration: 'Varierar med ämnet',
    description:
      'Kan ingå beroende på ämne. Laborationer har fasta tider på samma sätt som de skriftliga proven.',
  },
];
...
export const EXAMS: Exam[] = [
  ...
  {
    id: 'helsingborg-ma2b',
    schoolName: 'Arena Utbildning Helsingborg',
    ...
    city: 'Helsingborg',
    region: 'Skåne',
    address: 'Arena Utbildning, Planteringsvägen 5, Helsingborg',
    lat: 56.0276,
    lng: 12.713,
    price: 500,
    priceNote: HBG_PRICE_NOTE,
    nextPeriod: HBG_PERIOD_4,
    components: COMPONENTS_HELSINGBORG,
    studyTips: TIPS_MATEMATIK,
    registrationUrl: HBG_REGISTRATION_URL,
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i den gamla kursen Matematik 2b (MATMAT02b) i Helsingborg. Stadens webbansökan tar bara emot Gy25-nivåerna: du anmäler dig till Matematik Nivå 2b (MATE2B00X) och mejlar sedan betygsprovning@helsingborg.se för att pröva Gy11-kursen i stället, vilket bara går om du redan har ett betyg i kursen. Prövningen genomförs av Arena Utbildning, med lärplattformen Exlearn och ett fast provdatum inom perioden.',
    tags: ['matematik', 'helsingborg', 'skåne', 'gy11'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    id: 'lund-ma',
  ...
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Biologi Nivå 1 (BIOG1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Biologi 1 (BIOBIO01) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
  ...
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Biologi Nivå 2 (BIOG2000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Biologi 2 (BIOBIO02) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['biologi', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Engelska Nivå 1 (ENGE1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Engelska 5 (ENGENG05) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
  ...
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Engelska Nivå 2 (ENGE2000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Engelska 6 (ENGENG06) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['engelska', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Engelska Nivå 3 (ENGE3000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Engelska 7 (ENGENG07) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['engelska', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Entreprenörskap Nivå 1 (ENTR1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Entreprenörskap (ENTENR0) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
  ...
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Entreprenörskap och företagande Nivå 1 (ENTP1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Entreprenörskap och företagande (FÖRENT0) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
  ...
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Filosofi Nivå 1 (FILS1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Filosofi 1 (FIOFIO01) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
  ...
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Filosofi Nivå 2 (FILS2000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Filosofi 2 (FIOFIO02) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['filosofi', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Fysik Nivå 1b (FYSK1B00X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Fysik 1a (FYSFYS01a) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
  ...
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Fysik Nivå 1a1 (FYSK1A10X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Fysik 1b1 (FYSFYS01b1) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['fysik', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Fysik Nivå 1a2 (FYSK1A20X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Fysik 1b2 (FYSFYS01b2) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['fysik', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Fysik Nivå 2 (FYSK2000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Fysik 2 (FYSFYS02) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['fysik', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Företagsekonomi Nivå 1 (FOET1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Företagsekonomi 1 (FÖRFÖR01) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['företagsekonomi', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Företagsekonomi Nivå 2 (FOET2000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Företagsekonomi 2 (FÖRFÖR02) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['företagsekonomi', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Geografi Nivå 1 (GEOG1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Geografi 1 (GEOGEO01) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
  ...
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Geografi Nivå 2 (GEOG2000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Geografi 2 (GEOGEO02) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['geografi', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Historia Nivå 1a1 (HIST1A10X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Historia 1a1 (HISHIS01a1) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
  ...
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Historia Nivå 1a2 (HIST1A20X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Historia 1a2 (HISHIS01a2) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['historia', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Historia Nivå 1b (HIST1B00X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Historia 1b (HISHIS01b) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['historia', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Historia Nivå 2a (HIST2A00X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Historia 2a (HISHIS02a) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['historia', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Historia Nivå 2b (HIST2B00X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Historia 2b - kultur (HISHIS02b) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['historia', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Hälsopedagogik Nivå 1 (HALS1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Hälsopedagogik (HALAHL0) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
  ...
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Internationell ekonomi Nivå 1 (INTE1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Internationell ekonomi (SAMINE0) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
  ...
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Internationella relationer Nivå 1 (INTR1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Internationella relationer (SAMINR0) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['samhällskunskap', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Kemi Nivå 1 (KEMI1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Kemi 1 (KEMKEM01) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
  ...
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Kemi Nivå 2 (KEMI2000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Kemi 2 (KEMKEM02) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['kemi', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Latin – språk och kultur Nivå 1 (LATI1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Latin – språk och kultur (LATLAT01) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
  ...
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Ledarskap och organisation Nivå 1 (LEDA1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Ledarskap och organisation (LEDLED0) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
  ...
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Marknadsföring Nivå 1 (MARK1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Marknadsföring (FÖRMAD0) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['företagsekonomi', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Matematik Nivå 1a (MATE1A00X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Matematik 1a (MATMAT01a) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
  ...
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Matematik Nivå 1b (MATE1B00X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Matematik 1b (MATMAT01b) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['matematik', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Matematik Nivå 1c (MATE1C00X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Matematik 1c (MATMAT01c) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['matematik', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Matematik Nivå 2a (MATE2A00X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Matematik 2a (MATMAT02a) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['matematik', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Matematik Nivå 2b (MATE2B00X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Matematik 2b (MATMAT02b) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['matematik', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Matematik Nivå 2c (MATE2C00X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Matematik 2c (MATMAT02c) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['matematik', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Matematik – fortsättning Nivå 1b (MATO1B00X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Matematik 3b (MATMAT03b) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['matematik', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Matematik – fortsättning Nivå 1c (MATO1C00X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Matematik 3c (MATMAT03c) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['matematik', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Matematik – fortsättning Nivå 2 (MATO2000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Matematik 4 (MATMAT04) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['matematik', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Matematik – fördjupning Nivå 1 (MATF1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Matematik 5 (MATMAT05) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['matematik', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Matematik – specialisering B Nivå 1 (MASB1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Matematik specialisering (MATMAT00S) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['matematik', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Matematik – specialisering C Nivå 1 (MASC1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Matematik specialisering (MATMAT00S) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['matematik', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Naturkunskap Nivå 1a1 (NATU1A10X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Naturkunskap 1a1 (NAKNAK01a1) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
  ...
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Naturkunskap Nivå 1a2 (NATU1A20X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Naturkunskap 1a2 (NAKNAK01a2) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['naturkunskap', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Naturkunskap Nivå 1b (NATU1B00X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Naturkunskap 1b (NAKNAK01b) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['naturkunskap', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Naturkunskap Nivå 2 (NATU2000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Naturkunskap 2 (NAKNAK02) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['naturkunskap', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Programmering Nivå 1 (PROG1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Programmering 1 (PRRPRR01) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
  ...
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Programmering Nivå 2 (PROG2000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Programmering 2 (PRRPRR02) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['programmering', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Psykiatri Nivå 1 (PSYK1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Psykiatri 1 (PSYPSY01) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['vård och omsorg', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Psykologi Nivå 1 (PSYL1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Psykologi 1 (PSKPSY01) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
  ...
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Redovisning Nivå 1 (REDO1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Redovisning 1 (FÖRRED01) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['företagsekonomi', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Religionskunskap Nivå 1 (RELI1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Religionskunskap 1 (RELREL01) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
  ...
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Religionskunskap Nivå 2 (RELI2000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Religionskunskap 2 (RELREL02) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['religionskunskap', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Retorik Nivå 1 (RETO1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Retorik (SVERET0) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
  ...
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Samhällskunskap Nivå 1a1 (SAMH1A10X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Samhällskunskap 1a1 (SAMSAM01a1) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['samhällskunskap', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Samhällskunskap Nivå 1a2 (SAMH1A20X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Samhällskunskap 1a2 (SAMSAM01a2) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['samhällskunskap', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Samhällskunskap Nivå 1b (SAMH1B00X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Samhällskunskap 1b (SAMSAM01b) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['samhällskunskap', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Samhällskunskap Nivå 2 (SAMH2000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Samhällskunskap 2 (SAMSAM02) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['samhällskunskap', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Samhällskunskap Nivå 3 (SAMH3000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Samhällskunskap 3 (SAMSAM03) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['samhällskunskap', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Specialpedagogik Nivå 1 (SPEI1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25; kommunens lista skriver inte ut någon motsvarande Gy11-kurs.',
    tags: ['vård och omsorg', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Svenska Nivå 1 (SVEN1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Svenska 1 (SVESVE01) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['svenska', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Svenska Nivå 2 (SVEN2000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Svenska 2 (SVESVE02) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['svenska', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Svenska Nivå 3 (SVEN3000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Svenska 3 (SVESVE03) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['svenska', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Svenska som andraspråk Nivå 1 (SVEA1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Svenska som andraspråk 1 (SVASVA01) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
  ...
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Svenska som andraspråk Nivå 2 (SVEA2000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Svenska som andraspråk 2 (SVASVA02) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['svenska som andraspråk', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Svenska som andraspråk Nivå 3 (SVEA3000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Svenska som andraspråk 3 (SVASVA03) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['svenska som andraspråk', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Teknik Nivå 1 (TEKI1000X) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Teknik 1 (TEKTEK01) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
  ...
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Moderna språk – nybörjare Nivå 1, Franska (MODY1000XFRA) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Moderna språk 1 (MODFRA01) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
  ...
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Moderna språk – grund Nivå 1, Franska (MODG1000XFRA) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Moderna språk 2 (MODFRA02) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['moderna språk', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Moderna språk – fortsättning Nivå 1, Franska (MODO1000XFRA) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Moderna språk 3 (MODFRA03) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['moderna språk', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Moderna språk – fortsättning Nivå 2, Franska (MODO2000XFRA) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Moderna språk 4 (MODFRA04) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['moderna språk', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Moderna språk – fördjupning Nivå 1, Franska (MODF1000XFRA) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Moderna språk 5 (MODFRA05) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['moderna språk', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Moderna språk – nybörjare Nivå 1, Tyska (MODY1000XDEU) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Moderna språk 1 (MODDEU01) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['moderna språk', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Moderna språk – grund Nivå 1, Tyska (MODG1000XDEU) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Moderna språk 2 (MODDEU02) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['moderna språk', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Moderna språk – fortsättning Nivå 1, Tyska (MODO1000XDEU) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Moderna språk 3 (MODDEU03) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['moderna språk', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Moderna språk – fortsättning Nivå 2, Tyska (MODO2000XDEU) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Moderna språk 4 (MODDEU04) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['moderna språk', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Moderna språk – fördjupning Nivå 1, Tyska (MODF1000XDEU) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Moderna språk 5 (MODDEU05) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['moderna språk', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Moderna språk – nybörjare Nivå 1, Spanska (MODY1000XSPA) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Moderna språk 1 (MODSPA1) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['moderna språk', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Moderna språk – grund Nivå 1, Spanska (MODG1000XSPA) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Moderna språk 2 (MODSPA2) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['moderna språk', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Moderna språk – fortsättning Nivå 1, Spanska (MODO1000XSPA) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Moderna språk 3 (MODSPA3) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['moderna språk', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Moderna språk – fortsättning Nivå 2, Spanska (MODO2000XSPA) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Moderna språk 4 (MODSPA4) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['moderna språk', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Moderna språk – nybörjare Nivå 1, Italienska (MODY1000XITA) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Moderna språk 1 (MODITA1) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['moderna språk', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Moderna språk – grund Nivå 1, Italienska (MODG1000XITA) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Moderna språk 2 (MODITA2) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['moderna språk', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Moderna språk – fortsättning Nivå 1, Italienska (MODO1000XITA) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Moderna språk 3 (MODITA3) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['moderna språk', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Moderna språk – nybörjare Nivå 1, Danska (MODY1000XDAN) i Helsingborg. Arena Utbildning genomför stadens prövningar: du anmäler dig i Helsingborgs webbansökan, bifogar tidigare betyg och betalar senast sista anmälningsdag, och får därefter inloggning till lärplattformen Exlearn. Skriftliga prov och laborationer har fasta tider och görs på plats, det muntliga provet bokar du med läraren. Anmälan görs i Gy25. Vill du i stället pröva den gamla kursen Moderna språk 1 (MODDAN1) mejlar du betygsprovning@helsingborg.se efter anmälan, vilket bara går om du redan har ett betyg i kursen.',
    tags: ['moderna språk', 'helsingborg', 'skåne', 'gy25'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    id: 'helsingborg-grund-engelska',
    ...
    price: 500,
    priceNote: HBG_PRICE_NOTE,
    nextPeriod: HBG_GRUND_PERIOD_2,
    components: COMPONENTS_HELSINGBORG,
    studyTips: TIPS_ENGELSKA,
    registrationUrl: HBG_REGISTRATION_URL,
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Engelska grundläggande nivå hos Komvux Helsingborg. Grundläggande prövningar har två perioder om året; höstens anmälan var öppen 7–11 september 2026 och proven görs 12 oktober–6 november. Du anmäler dig i stadens webbansökan, bifogar tidigare betyg och betalar 500 kr senast sista anmälningsdag. Kommunen publicerar ingen kurskod för prövningar på grundläggande nivå.',
    tags: ['engelska', 'helsingborg', 'skåne', 'grundläggande'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    id: 'helsingborg-grund-matematik',
    schoolName: 'Komvux Helsingborg',
    provider: 'Helsingborgs stad',
    subject: 'Matematik',
    course: 'Matematik grundläggande nivå',
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Matematik grundläggande nivå hos Komvux Helsingborg. Grundläggande prövningar har två perioder om året; höstens anmälan var öppen 7–11 september 2026 och proven görs 12 oktober–6 november. Du anmäler dig i stadens webbansökan, bifogar tidigare betyg och betalar 500 kr senast sista anmälningsdag. Kommunen publicerar ingen kurskod för prövningar på grundläggande nivå.',
    tags: ['matematik', 'helsingborg', 'skåne', 'grundläggande'],
    verifiedAt: SEP_18_VERIFIED,
  },
  {
    id: 'helsingborg-grund-svenska',
    schoolName: 'Komvux Helsingborg',
    provider: 'Helsingborgs stad',
    subject: 'Svenska',
    course: 'Svenska grundläggande nivå',
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Svenska grundläggande nivå hos Komvux Helsingborg. Grundläggande prövningar har två perioder om året; höstens anmälan var öppen 7–11 september 2026 och proven görs 12 oktober–6 november. Du anmäler dig i stadens webbansökan, bifogar tidigare betyg och betalar 500 kr senast sista anmälningsdag. Kommunen publicerar ingen kurskod för prövningar på grundläggande nivå.',
  ...
  },
  {
    ...
    infoUrl: HBG_INFO_URL,
    description:
      'Betygsprövning i Svenska som andraspråk grundläggande nivå hos Komvux Helsingborg. Grundläggande prövningar har två perioder om året; höstens anmälan var öppen 7–11 september 2026 och proven görs 12 oktober–6 november. Du anmäler dig i stadens webbansökan, bifogar tidigare betyg och betalar 500 kr senast sista anmälningsdag. Kommunen publicerar ingen kurskod för prövningar på grundläggande nivå.',
