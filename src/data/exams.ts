...
// Listings added after a link-health sweep found every kommun below running an
// open Alvis prövning flow — the URL goes straight to the subject picker, which
// is step 1 of 3 in the booking, not another municipal landing page.
const ALVIS_VERIFIED = '2026-08-10';
...
export const EXAMS: Exam[] = [
  ...
  },
  {
    ...
    infoUrl: 'https://www.lulea.se/utbildning--forskola/vuxenutbildning.html',
  ...
  },
  {
    ...
    registrationUrl: 'https://sundsvall.se/kommun/utbildning-och-forskola/vuxenutbildning/ansokan/provning',
  ...
  },
  {
    ...
    components: COMPONENTS_FLERA,
    studyTips: TIPS_FLERA,
    registrationUrl: 'https://www.larcentrum.se/ostersund/provning/',
  ...
  },
  {
    ...
    components: COMPONENTS_FLERA,
    studyTips: TIPS_FLERA,
    registrationUrl: 'https://www.molndal.se/campus-molndal/dina-studier/provning',
    infoUrl: 'https://www.molndal.se/campus-molndal/dina-studier/provning/flikar/datum-for-provningar',
  ...
  },
  {
    ...
    priceNote: '500 kr per prövning enligt Skolverkets förordning.',
    nextPeriod: {
      label: 'Anmälan till vårens prövningar öppnar 17 november 2026 och stänger 4 januari 2027. Provdatum sätts individuellt — läraren kontaktar dig ca två veckor efter sista anmälningsdag.',
    ...
    components: COMPONENTS_FLERA,
    studyTips: TIPS_FLERA,
    registrationUrl: 'https://sundbyberg.alvis.se/provning/amnesomrade',
    infoUrl: 'https://sundbyberg.alvis.se/provning/amnesomrade',
  ...
  {
    id: 'jarfalla-larcentrum-vard-och-omsorg',
    schoolName: 'Järfälla Lärcentrum',
    provider: 'Järfälla kommun',
    subject: 'Vård och omsorg',
    course: 'Flera kurser inom vård och omsorg (30 kurser i utbudet)',
    courseCode: 'Varierar',
    level: 'Komvux',
    city: 'Järfälla',
    region: 'Stockholm',
    address: 'Järfälla Lärcentrum, Jakobsberg (sal meddelas i kallelsen)',
    lat: 59.4233,
    lng: 17.8353,
    price: 500,
    priceNote: '500 kr per kurs. Kostnadsfritt om du har betyg F eller IG i kursen och skickar in betygskopia.',
    nextPeriod: {
      label: 'Period 5: första provmomentet 10 november 2026 kl. 13.00–16.00, anmälan senast 13 oktober. Betyg utfärdas 18 december.',
    ...
    infoUrl: 'https://jarfalla.alvis.se/provning/amnesomrade',
    description: 'Järfälla Lärcentrum har det bredaste prövningsutbudet inom vård och omsorg i norra Stockholm — ett trettiotal kurser. Prövningarna körs i fasta perioder med ett gemensamt första provmoment och betyg drygt en månad senare.',
    tags: ['komvux', 'vård och omsorg', 'järfälla'],
    verifiedAt: ALVIS_VERIFIED,
  },
  {
    id: 'jarfalla-larcentrum-sprak',
    schoolName: 'Järfälla Lärcentrum',
    provider: 'Järfälla kommun',
    subject: 'Engelska',
    course: 'Flera språkkurser (19 kurser i utbudet)',
    courseCode: 'Varierar',
    level: 'Komvux',
    city: 'Järfälla',
    region: 'Stockholm',
    ...
    registrationUrl: 'https://jarfalla.alvis.se/provning/amnesomrade',
    infoUrl: 'https://jarfalla.alvis.se/provning/amnesomrade',
    description: 'Järfälla Lärcentrum erbjuder prövning i ett nittontal språkkurser, inklusive engelska på gymnasial nivå. Välj ämnesområdet Språk i anmälan för att se vilka kurser som är öppna för perioden.',
    tags: ['komvux', 'språk', 'järfälla'],
    verifiedAt: ALVIS_VERIFIED,
  },
  {
    id: 'flen-vuxenutbildningen-engelska',
    schoolName: 'Vuxenutbildningen i Flen',
    provider: 'Flens kommun',
    subject: 'Engelska',
    course: 'Engelska (gymnasial nivå)',
    courseCode: 'Varierar',
    level: 'Komvux',
    city: 'Flen',
    region: 'Södermanland',
    address: 'Vuxenutbildningen i Flen (adress bekräftas i kallelsen)',
    lat: 59.0570,
    lng: 16.5876,
    price: 500,
    priceNote: 'Begränsat antal prövningsplatser — plats kan inte garanteras.',
    nextPeriod: {
      label: 'Prövning i engelska 9 oktober 2026. Anmälan stänger 1 september, antagningsbesked 20 september.',
      applicationEnd: '2026-09-01',
      examWindowStart: '2026-10-09',
      examWindowEnd: '2026-10-09',
      confirmed: true,
    },
    components: COMPONENTS_ENGELSKA,
    studyTips: TIPS_ENGELSKA,
    registrationUrl: 'https://flen.alvis.se/provning/amnesomrade',
    infoUrl: 'https://flen.alvis.se/provning/amnesomrade',
    description: 'Flen publicerar hela höstens prövningsschema per ämne med separata provdatum. Anmälan sker i Alvis och antagningsbeskedet kommer knappt tre veckor innan provet.',
    tags: ['komvux', 'engelska', 'flen'],
    verifiedAt: ALVIS_VERIFIED,
  },
  {
    id: 'flen-vuxenutbildningen-matematik',
    schoolName: 'Vuxenutbildningen i Flen',
    provider: 'Flens kommun',
    subject: 'Matematik',
    course: 'Matematik (15 kurser i utbudet)',
    courseCode: 'Varierar',
    level: 'Komvux',
    city: 'Flen',
    region: 'Södermanland',
    ...
    priceNote: 'Begränsat antal prövningsplatser — plats kan inte garanteras.',
    nextPeriod: {
      label: 'Prövning i matematik 13 oktober 2026. Anmälan stänger 1 september, antagningsbesked 20 september.',
      applicationEnd: '2026-09-01',
    ...
    registrationUrl: 'https://flen.alvis.se/provning/amnesomrade',
    infoUrl: 'https://flen.alvis.se/provning/amnesomrade',
    description: 'Flen har ett brett matematikutbud för prövning — femton kurser från grundläggande till Matematik 4. Provdatum för hösten 2026 är satt till 13 oktober.',
    tags: ['komvux', 'matematik', 'flen'],
    verifiedAt: ALVIS_VERIFIED,
  },
  {
    id: 'flen-vuxenutbildningen-sva',
    schoolName: 'Vuxenutbildningen i Flen',
    provider: 'Flens kommun',
    subject: 'Svenska som andraspråk',
    course: 'Svenska som andraspråk (gymnasial nivå)',
    courseCode: 'Varierar',
    level: 'Komvux',
    city: 'Flen',
    region: 'Södermanland',
    ...
    priceNote: 'Begränsat antal prövningsplatser — plats kan inte garanteras.',
    nextPeriod: {
      label: 'Prövning i svenska som andraspråk 6 oktober 2026. Anmälan stänger 1 september, antagningsbesked 20 september.',
      applicationEnd: '2026-09-01',
    ...
    registrationUrl: 'https://flen.alvis.se/provning/amnesomrade',
    infoUrl: 'https://flen.alvis.se/provning/amnesomrade',
    description: 'Flen kör prövning i svenska som andraspråk 6 oktober 2026. SFI-kurserna B, C och D har eget provdatum 28 september samma anmälningsperiod.',
    tags: ['komvux', 'svenska som andraspråk', 'flen'],
    verifiedAt: ALVIS_VERIFIED,
  },
  {
    id: 'c3l-tyreso-matematik',
    schoolName: 'C3L Tyresö komvux',
    provider: 'Tyresö kommun',
    subject: 'Matematik',
    course: 'Matematik (5 kurser i utbudet)',
    courseCode: 'Varierar',
    level: 'Komvux',
    city: 'Tyresö',
    region: 'Stockholm',
    address: 'C3L, Bollmora, Tyresö (adress bekräftas vid anmälan)',
    lat: 59.2438,
    lng: 18.2280,
    price: 500,
    priceNote: '500 kr per kurs. Kostnadsfritt vid tidigare betyg F eller IG i kursen, mot uppvisat betygsdokument.',
    nextPeriod: {
      label: 'C3L har ett begränsat antal platser och öppnar anmälan periodvis — nästa period är inte publicerad. Anmälningsformuläret visar aktuell period när den öppnar.',
      confirmed: false,
    },
    components: COMPONENTS_MATEMATIK,
    studyTips: TIPS_MATEMATIK,
    registrationUrl: 'https://tyreso.alvis.se/provning/amnesomrade',
    infoUrl: 'https://tyreso.alvis.se/provning/amnesomrade',
    description: 'C3L i Tyresö erbjuder prövning i matematik, engelska, svenska och svenska som andraspråk. Först till kvarn gäller — anmälan kan stänga innan sista anmälningsdagen.',
    tags: ['komvux', 'matematik', 'tyresö'],
    verifiedAt: ALVIS_VERIFIED,
  },
  {
    id: 'campus-botkyrka-sva-engelska',
    schoolName: 'Komvux Campus Botkyrka',
    provider: 'Botkyrka kommun',
    subject: 'Svenska som andraspråk',
    course: 'Svenska som andraspråk 4 / Engelska 4 / SFI kurs D',
    courseCode: 'Varierar',
    level: 'Komvux',
    city: 'Botkyrka',
    region: 'Stockholm',
    address: 'Campus Botkyrka, Tumba (adress bekräftas vid anmälan)',
    lat: 59.1988,
    lng: 17.8318,
    price: 500,
    priceNote: '500 kr per prövning. Först till kvarn — begränsat antal platser.',
    nextPeriod: {
      label: 'Vårens anmälningar är stängda. Höstens prövningsdatum är ännu inte publicerade — de läggs ut i anmälningsformuläret.',
      confirmed: false,
    },
    components: COMPONENTS_SVENSKA,
    studyTips: TIPS_SVENSKA,
    registrationUrl: 'https://botkyrka.alvis.se/provning/amnesomrade',
    infoUrl: 'https://botkyrka.alvis.se/provning/amnesomrade',
    description: 'Campus Botkyrka håller prövning i ett smalt men efterfrågat utbud: svenska som andraspråk 4, engelska 4 och SFI kurs D. Anmälan öppnar terminsvis i Alvis.',
    tags: ['komvux', 'svenska som andraspråk', 'botkyrka'],
    verifiedAt: ALVIS_VERIFIED,
  },
  {
    id: 'komvux-katrineholm-flera',
    schoolName: 'Komvux Katrineholm',
    provider: 'Katrineholms kommun',
    subject: 'Flera ämnen',
    course: 'Flera kurser (engelska, matematik, svenska, SvA, grundläggande, SFI)',
    courseCode: 'Varierar',
    level: 'Komvux',
    city: 'Katrineholm',
    region: 'Södermanland',
    address: 'Komvux Katrineholm (adress bekräftas vid anmälan)',
    lat: 59.0000,
    lng: 16.2062,
    price: 500,
    priceNote: 'Avgiften bekräftas vid anmälan; kostnadsfritt vid tidigare betyg F i kursen enligt Skolverkets förordning.',
    nextPeriod: {
      label: 'Anmälan är öppen i Alvis, men Katrineholm publicerar inte provdatum i förväg — du får datum efter att anmälan behandlats.',
      confirmed: false,
    },
    components: COMPONENTS_FLERA,
    studyTips: TIPS_FLERA,
    registrationUrl: 'https://katrineholm.alvis.se/provning/amnesomrade',
    infoUrl: 'https://katrineholm.alvis.se/provning/amnesomrade',
    description: 'Komvux Katrineholm har 55 kurser öppna för prövning fördelat på engelska, matematik, svenska, svenska som andraspråk, grundläggande kurser och SFI.',
    tags: ['komvux', 'katrineholm', 'flera-amnen'],
    verifiedAt: ALVIS_VERIFIED,
  },
  {
    id: 'nvu-fagersta-flera',
    schoolName: 'Norra Västmanlands utbildningsförbund (NVU)',
    provider: 'Fagersta kommun',
    subject: 'Flera ämnen',
    course: 'Flera kurser (kontakta skolan för kurskod)',
    courseCode: 'Varierar',
    level: 'Komvux',
    city: 'Fagersta',
    region: 'Västmanland',
    address: 'NVU, Fagersta (adress bekräftas vid anmälan)',
    lat: 59.9789,
    lng: 15.7936,
    price: 500,
    priceNote: 'Avgiften bekräftas vid anmälan; kostnadsfritt vid tidigare betyg F i kursen enligt Skolverkets förordning.',
    nextPeriod: {
      label: 'Anmälan sker löpande i Alvis — aktuella prövningsperioder visas i formuläret.',
      confirmed: false,
    },
    components: COMPONENTS_FLERA,
    studyTips: TIPS_FLERA,
    registrationUrl: 'https://fagersta.alvis.se/provning/amnesomrade',
    infoUrl: 'https://fagersta.alvis.se/provning/amnesomrade',
    description: 'NVU sköter vuxenutbildningen för Fagersta, Norberg och Skinnskatteberg. Prövningsanmälan görs i Alvis och gäller för hela förbundets utbud.',
    tags: ['komvux', 'fagersta', 'västmanland'],
    verifiedAt: ALVIS_VERIFIED,
  },
];
